...
class ViewRequest extends Component {
  constructor(props) {
    ...
    this.handleRequestApprovalClick = this.handleRequestApprovalClick.bind(
      this
    );
      ...
      return (
        <Grid>
          ...
          <ButtonToolbar>
            ...
            <Button bsStyle="primary" onClick={this.handleApproveClick}>
              Approve
            </Button>
            <Button bsStyle="danger" onClick={this.handleRejectClick}>
              Reject
            </Button>
          </ButtonToolbar>
          <Footer />
